...
def load_data():
    ...
    print("train_pos:", train_pos.shape, ", train_neg:", train_neg.shape, ", test_pos:", test_pos.shape,
          ", test_neg:", test_neg.shape)
...
def evaluate():
    ...
    print("test_user: ", max(test_user))
    print("user_pos_items", user_pos_items)
    print("user_pos_items.keys()", user_pos_items.keys())
    users = list(user_pos_items.keys())
    print("users:", users)
    print("max in users", max(users))
